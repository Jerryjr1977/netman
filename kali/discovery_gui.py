...
def start_scan(url_entry, wordlist_entry, threads_entry, tree_widget, start_btn, stop_btn):
...
def build_discovery_tab(notebook):
    ...
    start_btn.config(command=lambda: start_scan(url_entry, wordlist_entry, threads_entry, results_tree, start_btn, stop_btn))
